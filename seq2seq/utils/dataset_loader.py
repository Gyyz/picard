...
from seq2seq.utils.gptsql import gptsql_add_serialized_schema, gptsql_pre_process_function
...
def load_dataset(
    ...
    _gptsql_add_serialized_schema = lambda ex: gptsql_add_serialized_schema(
        ex=ex,
        data_training_args=data_training_args,
    )
    ...
    elif data_args.dataset == 'gptsql':
        metric = _spider_metric()
        dataset_splits = prepare_splits(
            dataset_dict=(),
            add_serialized_schema=gptsql_add_serialized_schema,
            pre_process_function=gptsql_pre_process_function,
            **_prepare_splits_kwargs,
        )
